...
import LinkButtonIcon from "../Buttons/LinkButtonIcon/LinkButtonIcon";
...
export default function LeftNavigationExtended(props) {
    const {user} = props;
        ...
        <div className={styles.leftNavigationExtended}>
            ...
            <div className={styles.content}>
                <div className={styles.listActions}>
                    ...
                    <LinkButtonIcon name="Nitro" icon={
                ...
                <div className={styles.wrapper}>
                    <div className={styles.left}>
                        <div className={styles.avatarSection}>
                            ...
                            <div className={styles.statusIndicatorSection}>
                                <div>
                                    <div className={styles.statusIndicator + " " + styles[user?.activity]}></div>
                                </div>
                            </div>
                        </div>
                        <div className={styles.details}>
                            ...
                            <div className={styles.status}>
                                <span>{activityTypeToString(user?.activity)}</span>
                            </div>
                        </div>
                    </div>
                    <div className={styles.actions}>
                        <ButtonIcon icon={<HiMicrophone size={16}/>} active={!user?.microMuted}/>
                        <ButtonIcon icon={<BsHeadphones size={26}/>} active={!user?.soundMuted}/>
                        <ButtonIcon icon={<HiMiniCog8Tooth size={18}/>} active={false}/>
                    </div>
                </div>
            </div>
        </div>
...
function activityTypeToString(activity) {
    switch (activity) {
        case 'online':
            return 'En ligne';
        case 'away':
